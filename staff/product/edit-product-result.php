...
$pid = $_GET["pid"] ?? null;
$pname = $_GET["pname"] ?? null;
$message = $_GET["msg"] ?? "";

$pageTitle = "Edit Product Result";
$resultMessage = "";
$resultClass = "";
...
switch ($status) {
    case "success":
        ...
        $resultMessage = "Product '" . ($pname ? $pname : $pid) . "' (ID: " . $pid . ") has been updated successfully!";
        $resultClass = "alert-success";
        break;
    case "dberror":
        $pageTitle = "Update failed";
        $resultMessage = "Failed to update product (ID: " . $pid . "). ";
                    ...
                    <div id="items-section">
                        ...
                        <div id="result-container">
                            ...
                            <div id="result-actions">
                                <?php if ($status == "success" && $pid): ?>
                                    <button onclick="window.location.href='staff/product/edit-product.php?pid=<?php echo urlencode($pid); ?>'">Edit Again</button>
                                <?php elseif ($pid): ?>
                                    <button onclick="window.location.href='staff/product/edit-product.php?pid=<?php echo urlencode($pid); ?>'">Try Again</button>
                                <?php endif; ?>
